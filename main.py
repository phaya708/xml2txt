...
## フルパスに修正
## 拡張子によって変更
ext = '.png' # 画像拡張子を記載.jpgなど

#ここはanotetiondataフォルダの構成が変わっている場合個別に設定（基本的に変更なし）
addxmlpath = "./xml" # xmlを格納するフォルダパス
addimgpath = "./image" # 画像を格納するフォルダパス
outputpath = "./label" # 出力フォルダパス
classes_txt = "./classes.txt" # クラス名一覧テキスト
